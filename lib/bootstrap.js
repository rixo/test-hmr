...
module.exports = ({ appPath = config.appPath } = {}) => {
  ...
  const sveltePath = path.resolve(appPath, 'node_modules', 'svelte')
  ...
  if (fs.existsSync(appPath)) {
    ...
    // eslint-disable-next-line no-console
    console.log(`[HMR Test] Svelte v${version}`)
  } else {
    // eslint-disable-next-line no-console
    console.info('[HMR Test] No target app: e2e tests will be skipped')
  }
